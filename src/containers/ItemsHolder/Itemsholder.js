...
class ItemsHolder extends Component {
  ...
  componentWillUnmount() {
    // clears inputs or filters on the page
    this.props.onClearingSearchInput("");
    this.props.onClearCategorySelected();
  }
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    onClearingSearchInput: (emptyString) =>
      dispatch(actions.inputHandler(emptyString)),
    onClearCategorySelected: () => dispatch(actions.categoryResettingHandler()),
  };
};
